/**
 * Created by yediaoling on 2016/4/18.
 */

(function () {
    appPW.controller(
        'mainCtrl',function($scope,$http,ngTableParams) {
            var vm= this;
            ...
            require(
                ...
                function (ec) {
                    ...
                    var myChart = ec.init(document.getElementById('chuli'));
                    var option = {
                        title:{
                            text:'分布式电源出力分析图',
                            x:'center',
                        ...
                        legend: {
                            orient: 'vertical',
                            x: 'left',
                            data:['风力发电','光伏发电','储能装置','光伏发电1','光伏发电2','光伏发电3','蓄电池组1','蓄电池组2','锂电池组1','锂电池组1'],
                            textStyle: {
                        ...
                        series: [
                            {
                                ...
                                data:[
                                    {value:335, name:'风力发电', selected:true},
                                    {value:679, name:'光伏发电'},
                                    {value:1548, name:'储能装置'}
                                ],
                                itemStyle: {
                                    normal: {
                                        label: {
                            ...
                            },
                            {
                                ...
                                data:[
                                    {value:335, name:'风力发电'},
                                    {value:310, name:'光伏发电1'},
                                    {value:234, name:'光伏发电2'},
                                    {value:135, name:'光伏发电3'},
                                    {value:1048, name:'蓄电池组1'},
                                    {value:251, name:'蓄电池组2'},
                                    {value:147, name:'锂电池组1'},
                                    {value:102, name:'锂电池组2'}
                                ],
                                itemStyle: {
                                    normal: {
                                        label: {
            ...
            readDB(url);
            vm.regions = [
                {'name': '模拟拓扑1', 'id': 'ningbo','img':'resources/img/green1.png', 'description': '1'},
                {'name': '模拟拓扑2', 'id': 'cixi','img':'resources/img/red3.png', 'description': '3'},
                {'name': '模拟拓扑3','id': 'ningfengxiang','img':'resources/img/green1.png', 'description': '1'},
            ];
            vm.selectedRegion = vm.regions[0];
            vm.img = "resources/img/green1.png";
